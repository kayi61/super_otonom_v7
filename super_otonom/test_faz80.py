...
def _base_phase_dicts(now: int) -> dict:
    ...
    return {
        ...
        "p74": {"trade_permission": "ALLOW", "leadlag_alpha_score": 80, "latency_arb_risk": 10, "route_preference": "leader", "confidence": 0.9, "data_health": 0.9, "event_ts": now, "half_life_ms": 20_000},
        "p75": {"trade_permission": "ALLOW", "action": "TRADE", "conviction": 80, "max_size_multiplier": 1.1, "execution_profile": "taker", "alpha_score": 75, "risk_score": 25, "confidence": 0.9, "data_health": 0.9, "event_ts": now, "half_life_ms": 22_000},
        "p76": {"trade_permission": "ALLOW", "preferred_order_type": "taker", "slippage_risk": 25, "urgency_score": 60, "confidence": 0.9, "data_health": 0.9, "event_ts": now, "half_life_ms": 20_000},
        "p77": {"trade_permission": "ALLOW", "hunt_risk_score": 25, "stop_placement_hint": "keep", "confidence": 0.9, "data_health": 0.9, "event_ts": now, "half_life_ms": 35_000},
        "p78": {"trade_permission": "ALLOW", "alpha_freshness_score": 80, "exit_urgency": 15, "confidence": 0.9, "data_health": 0.9, "event_ts": now - 10_000, "half_life_ms": 30_000},
        "p79": {"trade_permission": "ALLOW", "mtf_consensus_score": 75, "conflict_flag": False, "entry_timing": "enter_now", "confidence": 0.9, "data_health": 0.9, "event_ts": now, "half_life_ms": 40_000},
    }
