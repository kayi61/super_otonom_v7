...
def test_faz78_decay_monotonicity() -> None:
    ...
    r_new = monitor_alpha_decay(
        symbol="BTC/USDT", analysis={"event_ts": now - 1_000, "half_life_ms": 30_000}, now_ts=now
    )
    r_old = monitor_alpha_decay(
        symbol="BTC/USDT", analysis={"event_ts": now - 90_000, "half_life_ms": 30_000}, now_ts=now
    )
