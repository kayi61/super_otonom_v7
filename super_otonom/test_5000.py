...
# Kaynak kodları
ce_src  = open("capital_engine.py", encoding="utf-8").read()
ro_src  = open("risk_ontology.py", encoding="utf-8").read()
rm_src  = open("risk_manager.py", encoding="utf-8").read()
oe_src  = open("order_engine.py", encoding="utf-8").read()
re_src  = open("reconciliation_engine.py", encoding="utf-8").read()
ptg_src = open("pre_trade_gate.py", encoding="utf-8").read()
am_src  = open("alert_manager.py", encoding="utf-8").read()
mi_src  = open("market_impact.py", encoding="utf-8").read()
cr_src  = open("concentration_risk.py", encoding="utf-8").read()
st_src  = open("stress_test.py", encoding="utf-8").read()
al_src  = open("audit_log.py", encoding="utf-8").read()
