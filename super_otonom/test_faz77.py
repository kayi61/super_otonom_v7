...
def test_faz77_invalid_price_does_not_crash() -> None:
    ...
    r = compute_smart_stop(symbol="BTC/USDT", side="LONG", last_price=0.0, analysis={"atr": 0.0, "volatility": 0.03})
...
def test_faz77_hunt_risk_widen_hint() -> None:
    ...
    r = compute_smart_stop(symbol="BTC/USDT", side="LONG", last_price=100.0, analysis={"atr": 1.0, "regime": "VOLATILE"}, hunt_risk_score=90)
