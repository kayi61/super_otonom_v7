...
# ── Ortam hazırlığı ──────────────────────────────────────────────────────────
_PKG_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "super_otonom")
...
# Kaynak kodları
ce_src = open(os.path.join(_PKG_DIR, "capital_engine.py"), encoding="utf-8").read()
ro_src = open(os.path.join(_PKG_DIR, "risk_ontology.py"), encoding="utf-8").read()
rm_src = open(os.path.join(_PKG_DIR, "risk_manager.py"), encoding="utf-8").read()
oe_src = open(os.path.join(_PKG_DIR, "order_engine.py"), encoding="utf-8").read()
re_src = open(os.path.join(_PKG_DIR, "reconciliation_engine.py"), encoding="utf-8").read()
ptg_src = open(os.path.join(_PKG_DIR, "pre_trade_gate.py"), encoding="utf-8").read()
am_src = open(os.path.join(_PKG_DIR, "alert_manager.py"), encoding="utf-8").read()
mi_src = open(os.path.join(_PKG_DIR, "market_impact.py"), encoding="utf-8").read()
cr_src = open(os.path.join(_PKG_DIR, "concentration_risk.py"), encoding="utf-8").read()
st_src = open(os.path.join(_PKG_DIR, "stress_test.py"), encoding="utf-8").read()
al_src = open(os.path.join(_PKG_DIR, "audit_log.py"), encoding="utf-8").read()
