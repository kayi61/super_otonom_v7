...
import pytest
from super_otonom.infra.observability_drill import run_drill
...
def test_drill_pass_when_metrics_and_telegram_ok(tmp_path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("super_otonom.infra.observability_drill._http_get", fake_get)
    monkeypatch.setattr("super_otonom.infra.observability_drill._http_post_json", fake_post)
