...
def test_faz75_block_propagates_to_wait_or_halt() -> None:
    ...
    r = compute_mm_whale_consensus(
        symbol="BTC/USDT", phase71=p71, phase72=p72, phase73=p73, phase74=p74
    )
